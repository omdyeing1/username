        ...
        <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="invoice_number" 
                                   value="{{ $invoice->invoice_number }}" readonly disabled>
                        </div>
                        <div class="col-md-3 mb-3">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div id="noPartySelected" class="text-center py-4 text-muted" style="display: none;">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <textarea class="form-control" name="notes" rows="2" placeholder="Additional notes...">{{ old('notes', $invoice->notes) }}</textarea>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-8">
                            ...
                            <input type="number" step="0.01" min="0" max="100" class="form-control calc-input" 
                                   id="gst_percent" name="gst_percent" value="{{ old('gst_percent', $invoice->gst_percent) }}">
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-8">
                            ...
                            <input type="number" step="0.01" min="0" max="100" class="form-control calc-input" 
                                   id="tds_percent" name="tds_percent" value="{{ old('tds_percent', $invoice->tds_percent) }}">
                        </div>
                        <div class="col-4 d-flex align-items-end">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" min="0" class="form-control calc-input" 
                                       id="discount_value" name="discount_value" value="{{ old('discount_value', $invoice->discount_value) }}">
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Current invoice challan IDs
    const currentInvoiceChallanIds = @json($invoice->challans->pluck('id')->toArray());
        ...
        fetch(`/api/parties/${partyId}/challans`)
            ...
            .then(data => {
                ...
                data.challans.forEach(challan => {
                    ...
                    const isChecked = currentInvoiceChallanIds.includes(challan.id) ? 'checked' : '';
                    if (isChecked) {
                        selectedChallans.push(challan.id.toString());
                    }
                    row.innerHTML = `
                        <td>
                            <input type="checkbox" class="form-check-input challan-check" 
                                   name="challan_ids[]" value="${challan.id}" 
                                   data-subtotal="${challan.subtotal_raw}" ${isChecked}>
                        </td>
