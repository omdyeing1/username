        ...
        <form action="{{ route('companies.update', $company) }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('state_code') is-invalid @enderror" 
                           id="state_code" name="state_code" value="{{ old('state_code', $company->state_code) }}" 
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('mobile_numbers') is-invalid @enderror" 
                           id="mobile_numbers" name="mobile_numbers" value="{{ old('mobile_numbers', $company->mobile_numbers) }}" 
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('ifsc_code') is-invalid @enderror" 
                           id="ifsc_code" name="ifsc_code" value="{{ old('ifsc_code', $company->ifsc_code) }}" 
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('account_number') is-invalid @enderror" 
                           id="account_number" name="account_number" value="{{ old('account_number', $company->account_number) }}">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('terms_conditions') is-invalid @enderror" 
                          id="terms_conditions" name="terms_conditions" rows="5">{{ old('terms_conditions', $company->terms_conditions) }}</textarea>
            ...
            <div class="mb-3">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="is_default" name="is_default" value="1" {{ old('is_default', $company->is_default) ? 'checked' : '' }}>
