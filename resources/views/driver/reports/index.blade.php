...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('driver.reports.index') }}" method="GET">
                     <div class="mb-3">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('driver.reports.index') }}" class="btn btn-outline-secondary">Reset</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <div class="card bg-primary text-white h-100">
                    <div class="card-body">
                        <h6 class="card-title opacity-75">My Trips</h6>
            ...
            <div class="col-md-4">
                <div class="card bg-success text-white h-100">
                    <div class="card-body">
                        <h6 class="card-title opacity-75">Earnings</h6>
             ...
             <div class="col-md-4">
                <div class="card bg-info text-white h-100">
                    <div class="card-body">
                         <h6 class="card-title opacity-75">Quantity Delivered</h6>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center py-4 text-muted">No trips match the selected filters.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
